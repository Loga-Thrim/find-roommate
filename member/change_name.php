                            ...
                            <div class="card-body p-5">
                                ...
                                <form>
                                    ...
                                    <div class="form-outline">
                                        <input type="text" id="form3Example1cg" class="form-control1 form-control-lg"placeholder="Name" />
                                    </div>

                                    <div class="form-outline">
                                        <input type="password" id="form3Example4cg"
                                            class="form-control1 form-control-lg"placeholder="Password" />
                                    </div>

                                    <div class="form-outline">
                                        <input type="password" id="form3Example4cdg"
                                            class="form-control1 form-control-lg"placeholder="Repeat your password" />
                                    </div>
